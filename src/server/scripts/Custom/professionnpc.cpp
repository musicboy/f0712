...
bool OnGossipHello(Player* pPlayer, Creature* pCreature)
{
	...
	if(EnableProfessions)
		pPlayer->ADD_GOSSIP_ITEM( 7, "专业技能 ->"        , GOSSIP_SENDER_MAIN, 1000);
	// Check config if "Secondary Skills" is enabled or not
	if(EnableSecondarySkills)
		pPlayer->ADD_GOSSIP_ITEM( 7, "生活技能 ->"   , GOSSIP_SENDER_MAIN, 2000);
	}
...
if (pPlayer->isInCombat())
{
    ...
    pCreature->MonsterSay("你是在战斗中!", LANG_UNIVERSAL, NULL);
	return;
}
...
{
    pPlayer->CLOSE_GOSSIP_MENU();
    pCreature->MonsterWhisper("你没有足够的金币.", pPlayer->GetGUID());
	return;
}
...
case 1000: //Profession
            pPlayer->ADD_GOSSIP_ITEM( 5, "1000G购买 10点 炼金 确定购买？"              , GOSSIP_SENDER_MAIN, 1001);
            pPlayer->ADD_GOSSIP_ITEM( 5, "1000G购买 10点 锻造 确定购买？"        , GOSSIP_SENDER_MAIN, 1002);
            pPlayer->ADD_GOSSIP_ITEM( 5, "1000G购买 10点 附魔 确定购买？"           , GOSSIP_SENDER_MAIN, 1003);
            pPlayer->ADD_GOSSIP_ITEM( 5, "1000G购买 10点 工程 确定购买？"          , GOSSIP_SENDER_MAIN, 1004);
            pPlayer->ADD_GOSSIP_ITEM( 5, "1000G购买 10点 草药 确定购买？"            , GOSSIP_SENDER_MAIN, 1005);
            pPlayer->ADD_GOSSIP_ITEM( 5, "1000G购买 10点 铭文 确定购买？"          , GOSSIP_SENDER_MAIN, 1006);
            pPlayer->ADD_GOSSIP_ITEM( 5, "1000G购买 10点 珠宝 确定购买？"        , GOSSIP_SENDER_MAIN, 1007);
            pPlayer->ADD_GOSSIP_ITEM( 5, "1000G购买 10点 拨皮 确定购买？"       , GOSSIP_SENDER_MAIN, 1008);
            pPlayer->ADD_GOSSIP_ITEM( 5, "1000G购买 10点 采矿 确定购买？"               , GOSSIP_SENDER_MAIN, 1009);
            pPlayer->ADD_GOSSIP_ITEM( 5, "1000G购买 10点 制皮 确定购买？"             , GOSSIP_SENDER_MAIN, 1010);
            pPlayer->ADD_GOSSIP_ITEM( 5, "1000G购买 10点 裁缝 确定购买？"            , GOSSIP_SENDER_MAIN, 1011);
            pPlayer->ADD_GOSSIP_ITEM( 7, "<- 主菜单"          , GOSSIP_SENDER_MAIN, 3000);

	pPlayer->SEND_GOSSIP_MENU(DEFAULT_GOSSIP_MESSAGE,pCreature->GetGUID());
break;

case 2000: //Secondary Skills
            pPlayer->ADD_GOSSIP_ITEM( 5, "烹饪."              , GOSSIP_SENDER_MAIN, 2001);
            pPlayer->ADD_GOSSIP_ITEM( 5, "急救."            , GOSSIP_SENDER_MAIN, 2002);
            pPlayer->ADD_GOSSIP_ITEM( 5, "钓鱼."              , GOSSIP_SENDER_MAIN, 2003);
...
case 1001: // Alchemy
	if(!pPlayer->UpdateSkill(171,0))
      {
		pCreature->MonsterWhisper("你不会这个技能 或者 你已经达到了最高水平 $C.", pPlayer->GetGUID());
